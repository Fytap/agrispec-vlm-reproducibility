...
\section{S9. Pre-specified CWFID transfer and continuous diagnostics}
...
\begin{table}[htbp]
\centering
\caption{Pre-specified CWFID endpoint. Every checkpoint produced the same structural outcome.}
\label{tab:s9locked}
\footnotesize
\setlength{\tabcolsep}{4pt}
\begin{tabular}{lrrrrrr}
...
\section{S12. Reproducibility resources}
