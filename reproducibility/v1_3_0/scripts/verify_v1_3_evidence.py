#!/usr/bin/env python3
"""Verify the public v1.3.0 evidence layer using only the standard library."""
...
def verify_merge_and_operator() -> None:
    ...
    close(human_mask[0]["f1"], 0.7591463414634146)
...
def verify_manifest() -> int:
    entries = load_tsv("manifests/v1_3_0_sha256.tsv")
